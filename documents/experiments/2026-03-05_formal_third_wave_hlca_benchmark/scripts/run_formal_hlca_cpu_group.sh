...
MANIFEST="${REPO_ROOT}/documents/experiments/2026-03-05_formal_third_wave_hlca_benchmark/manifests/reference_heldout/HLCA_Core__ann_level_5__formal_runtime_cpu_train10k_test5k_v1.yaml"
OUT_DIR="${OUT_DIR:-/tmp/atlasmtl_benchmarks/2026-03-05/reference_heldout/HLCA_Core/benchmark/formal_train10k_test5k/cpu_group_v1}"
