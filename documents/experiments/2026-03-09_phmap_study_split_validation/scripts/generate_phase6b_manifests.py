...
OUT_ROOT = DOSSIER_ROOT / "manifests" / "phase6b"
...
def main() -> None:
    ...
    for seed in SEEDS:
        ...
        for config_name, overrides in CONFIGS.items():
            ...
            out_payload["optimization_stage"] = "phase6b_train_time_child_correction"
            out_payload["config_name"] = f"atlasmtl_phase6b_{config_name}_seed_{seed}"
            out_payload["seed"] = seed
            out_path = OUT_ROOT / "train" / config_name / f"seed_{seed}" / "atlasmtl_phase6b_train.yaml"
